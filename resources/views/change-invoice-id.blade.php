...
@section('content')
    <div class="container" style="width: 400px; margin-top: 30px;">
        ...
        <div class="text-left card p-4 shadow">
            ...
            <form action="{{ route('change-invoice-id-post', $invoice_id->user_id) }}" method="POST">
                @csrf
                <div class="form-group mt-2">
                    <label for="invoice_id" class="small mb-0 pb-0"><strong>Invoice ID</strong></label>
                    <input type="text" name="invoice_id" placeholder="Invoice ID" class="form-control" required>
                </div>
